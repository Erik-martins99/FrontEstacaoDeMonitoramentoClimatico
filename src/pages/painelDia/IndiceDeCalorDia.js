...
import "../painelTempoReal/indiceDeCalor.css"

const IndiceDeCalorDia = () => {
  ...
  useEffect(() => {
    ...
    const fetchDados = async () => {
      try {
        const response = await fetch('http://localhost:8080/condicaoClimatica/dia');
...
export default IndiceDeCalorDia;
